...
# COMPLETAR - INICIO
#strings_concatenados = f"{variable_01.rstrip()} {variable_02} {variable_03.lstrip()} {variable_04}"
#print(strings_concatenados)
#print(len(str(variable_04)))
# ME DABA ERROR PORQUE HABÍA UN ESPACIO EN BLANCO ENTRE EL SIGNO PESOS Y EL NÚMERO CUATRO PORQUE LAS 
# LLAVES ESTABAN SEPARADAS CON UN ESPACIO EN BLANCO... FUCK
